(function () {
    ...
    document
      ...
      .forEach(function (container) {
        const stikyContainerHeight =
          container.querySelector(".content").scrollWidth;
  ...
  function wheelHandler(evt) {
    ...
    if (g_canScrollHorizontally) {
      containerInViewPort.querySelector(".content").scrollLeft += evt.deltaY;
      document.querySelector(".content").scrollTo({ behivor: "smooth" });
    }
  }
})();
